...
export function ChordHelper({ onInsertChord, className }: ChordHelperProps): JSX.Element {
    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent
                className="w-80 p-0 bg-white dark:bg-gray-800 border-blue-100 dark:border-blue-800"
                align="start"
            >
                <div className="p-4 pb-0">
                    <h4 className="text-sm font-medium text-blue-900 dark:text-blue-300 mb-2">
                        เลือกคอร์ดที่ต้องการเพิ่ม
                    </h4>
                ...
                <div className="p-4 pt-2 border-t border-gray-100 dark:border-gray-700">
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                        <strong>วิธีใช้:</strong> วางเคอร์เซอร์ในตำแหน่งที่ต้องการแทรกคอร์ด
                        แล้วคลิกที่คอร์ดที่ต้องการ
                    </p>
                </div>
            </PopoverContent>
        </Popover>
