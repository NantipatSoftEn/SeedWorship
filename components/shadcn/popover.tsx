...
const PopoverTrigger = React.forwardRef<React.ElementRef<typeof PopoverPrimitive.Trigger>, PopoverTriggerProps>(
  ({ asChild = false, ...props }, ref) => <PopoverPrimitive.Trigger ref={ref} asChild={asChild} {...props} />,
)
